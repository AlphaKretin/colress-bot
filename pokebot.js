...
bot.on('message', function(user, userID, channelID, message, event) {
	...
	if (gameRunning === "highlow2"){
		validateAnswerHiLo2(user, userID, channelID, message, event);
	}
...
function game(user, userID, channelID, message, event) {
    var input = message.toLowerCase().split(" ")[1];
    switch (input){
    	case "highlow": 
...
function gameHiLo(user, userID, channelID, message, event) {
    ...
    if (gameRunning !== "none") {
        ...
        gameDex = dex;
        gameGuesses = 0;
        sendMessage(user, userID, channelID, message, event, "You have 10 guesses to name National Pokédex number of the following Pokémon: **" + name + "**!");
    }
}
...
function validateAnswerHiLo(user, userID, channelID, message, event) {
    ...
    if (serverID !== gameServer || channelID !== gameChannel || userID === "247697943098818570") {
        ...
        for (var mon of mons) {
            if (mon.name === gameAnswer) {
                if (message === mon.dex.toString()) {
                    rightAnswer = true;
                    break;
                }
            }
...
function gameHiLo2(user, userID, channelID, message, event) {
    var serverID = bot.channels[channelID] && bot.channels[channelID].guild_id;
    if (gameRunning !== "none") {
        return;
    } else {
...
function validateAnswerHiLo2(user, userID, channelID, message, event) {
    var serverID = bot.channels[channelID] && bot.channels[channelID].guild_id;
    if (serverID !== gameServer || channelID !== gameChannel || userID === "247697943098818570") {
        return;
    } else {
...
function gameHangman(user, userID, channelID, message, event){
	var serverID = bot.channels[channelID] && bot.channels[channelID].guild_id;
    if (gameRunning !== "none") {
        return;
    } else {
        ...
        gameGuesses = 0;
        gameWrongs = [];
        sendMessage(user, userID, channelID, message, event, "Guess the letters in this Pokémon's name! You can make 10 mistakes before the game is over.\n`" + hint + "`");
        }
}

function validateAnswerHangman(user, userID, channelID, message, event){
	var serverID = bot.channels[channelID] && bot.channels[channelID].guild_id;
    if (serverID !== gameServer || channelID !== gameChannel) {
        return;
    } else {
    		...
    		if (gameAnswer.toLowerCase().indexOf(message.toLowerCase()) > -1) {
    			for (var i = 0; i < gameAnswer.length; i++){
    				if (gameAnswer.charAt(i).toLowerCase() === message.toLowerCase()){
    					gameHint = gameHint.replaceAt(i, gameAnswer.charAt(i));
    				}
    			}
...
var mons = [{id: "bulbasaur", name: "Bulbasaur", dex: 1, alola: -1, type: "Grass/Poison", ability: "Overgrow/None/Chlorophyll", wiki: "http://www.serebii.net/pokedex-sm/001.shtml", image: "http://www.serebii.net/sunmoon/pokemon/001.png"},
 ...
 {id: "rattata-a", name: "Alolan Rattata", dex: 19, alola: 13, type: "Dark/Normal", ability: "Gluttony/Hustle/Thick Fat", wiki: "http://www.serebii.net/pokedex-sm/019.shtml", image: "http://www.serebii.net/sunmoon/pokemon/019-a.png"},
 {id: "raticate-a", name: "Alolan Raticate", dex: 20, alola: 14, type: "Dark Normal", ability: "Gluttony/Hustle/Thick Fat", wiki: "http://www.serebii.net/pokedex-sm/020.shtml", image: "http://www.serebii.net/sunmoon/pokemon/020-a.png"},
 ...
 {id: "raichu-a", name: "Alolan Raichu", dex: 26, alola: 22, type: "Electric/Psychic", ability: "Surge Surfer", wiki: "http://www.serebii.net/pokedex-sm/026.shtml", image: "http://www.serebii.net/sunmoon/pokemon/026-a.png"},
 ...
 {id: "sandshrew-a", name: "Alolan Sandshrew", dex: 27, alola: 251, type: "Ice/Steel", ability: "Snow Cloak/None/Slush Rush", wiki: "http://www.serebii.net/pokedex-sm/027.shtml", image: "http://www.serebii.net/sunmoon/pokemon/027-a.png"},
 {id: "sandslash-a", name: "Alolan Sandslash", dex: 28, alola: 252, type: "Ice/Steel", ability: "Snow Cloak/None/Slush Rush", wiki: "http://www.serebii.net/pokedex-sm/028.shtml", image: "http://www.serebii.net/sunmoon/pokemon/028-a.png"},
 ...
 {id: "vulpix-a", name: "Alolan Vulpix", dex: 37, alola: 253, type: "Ice", ability: "Snow Cloak/None/Snow Warning", wiki: "http://www.serebii.net/pokedex-sm/037.shtml", image: "http://www.serebii.net/sunmoon/pokemon/037-a.png"},
 {id: "ninetales-a", name: "Alolan Ninetales", dex: 38, alola: 254, type: "Ice/Fairy", ability: "Snow Cloak/None/Snow Warning", wiki: "http://www.serebii.net/pokedex-sm/038.shtml", image: "http://www.serebii.net/sunmoon/pokemon/038-a.png"},
 ...
 {id: "diglett-a", name: "Alolan Diglett", dex: 50, alola: 57, type: "Ground/Steel", ability: "Sand Veil/Tangling Hair/Sand Force", wiki: "http://www.serebii.net/pokedex-sm/050.shtml", image: "http://www.serebii.net/sunmoon/pokemon/050-a.png"},
 {id: "dugtrio-a", name: "Alolan Dugtrio", dex: 51, alola: 58, type: "Ground/Steel", ability: "Sand Veil/Tangling Hair/Sand Force", wiki: "http://www.serebii.net/pokedex-sm/051.shtml", image: "http://www.serebii.net/sunmoon/pokemon/051-a.png"},
 ...
 {id: "meowth-a", name: "Alolan Meowth", dex: 52, alola: 37, type: "Dark", ability: "Pickup/Technician/Rattled", wiki: "http://www.serebii.net/pokedex-sm/052.shtml", image: "http://www.serebii.net/sunmoon/pokemon/052-a.png"},
 {id: "persian-a", name: "Alolan Persian", dex: 53, alola: 38, type: "Dark", ability: "Limber/Technician/Rattled", wiki: "http://www.serebii.net/pokedex-sm/053.shtml", image: "http://www.serebii.net/sunmoon/pokemon/053-a.png"},
 ...
 {id: "grimer-a", name: "Alolan Grimer", dex: 88, alola: 40, type: "Poison/Dark", ability: "Poison Touch/Gluttony/Power of Alchemy", wiki: "http://www.serebii.net/pokedex-sm/088.shtml", image: "http://www.serebii.net/sunmoon/pokemon/088-a.png"},
 {id: "muk-a", name: "Alolan Muk", dex: 89, alola: 41, type: "Poison/Dark", ability: "Poison Touch/Gluttony/Power of Alchemy", wiki: "http://www.serebii.net/pokedex-sm/089.shtml", image: "http://www.serebii.net/sunmoon/pokemon/089-a.png"},
 ...
 {id: "exeggutor-a", name: "Alolan Exeggutor", dex: 103, alola: 270, type: "Grass/Dragon", ability: "Frisk/None/Harvest", wiki: "http://www.serebii.net/pokedex-sm/103.shtml", image: "http://www.serebii.net/sunmoon/pokemon/103-a.png"},
 ...
 {id: "marowak-a", name: "Alolan Marowak", dex: 105, alola: 164, type: "Fire/Ghost", ability: "Rock Head/Lightning Rod/Battle Armor", wiki: "http://www.serebii.net/pokedex-sm/105.shtml", image: "http://www.serebii.net/sunmoon/pokemon/105-a.png"},
 ...
 {id: "castform fire", name: "Castform Sunny", dex: 351, alola: -1, type: "Fire", ability: "Forecast", wiki: "http://www.serebii.net/pokedex-sm/351.shtml", image: "http://www.serebii.net/sunmoon/pokemon/351-s.png"},
 {id: "castform water", name: "Castform", dex: 351, alola: -1, type: "Water", ability: "Forecast", wiki: "http://www.serebii.net/pokedex-sm/351.shtml", image: "http://www.serebii.net/sunmoon/pokemon/351-r.png"},
 {id: "castform ice", name: "Castform Snowy", dex: 351, alola: -1, type: "Ice", ability: "Forecast", wiki: "http://www.serebii.net/pokedex-sm/351.shtml", image: "http://www.serebii.net/sunmoon/pokemon/351-i.png"},
 ...
 {id: "wormadam ground", name: "Wormadam Sandy", dex: 413, alola: -1, type: "Bug/Ground", ability: "Anticipation/None/Overcoat", wiki: "http://www.serebii.net/pokedex-sm/413.shtml", image: "http://www.serebii.net/sunmoon/pokemon/413-c.png"},
 {id: "wormadam steel", name: "Wormadam Trash", dex: 413, alola: -1, type: "Bug/Steel", ability: "Anticipation/None/Overcoat", wiki: "http://www.serebii.net/pokedex-sm/413.shtml", image: "http://www.serebii.net/sunmoon/pokemon/413-s.png"},
 ...
 {id: "rotom fire", name: "Rotom Heat", dex: 479, alola: -1, type: "Electric/Fire", ability: "Levitate", wiki: "http://www.serebii.net/pokedex-sm/479.shtml", image: "http://www.serebii.net/sunmoon/pokemon/479-h.png"},
 {id: "rotom water", name: "Rotom Wash", dex: 479, alola: -1, type: "Electric/Water", ability: "Levitate", wiki: "http://www.serebii.net/pokedex-sm/479.shtml", image: "http://www.serebii.net/sunmoon/pokemon/479-w.png"},
 {id: "rotom grass", name: "Rotom Mow", dex: 479, alola: -1, type: "Electric/Grass", ability: "Levitate", wiki: "http://www.serebii.net/pokedex-sm/479.shtml", image: "http://www.serebii.net/sunmoon/pokemon/479-m.png"},
 {id: "rotom flying", name: "Rotom Fan", dex: 479, alola: -1, type: "Electric/Flying", ability: "Levitate", wiki: "http://www.serebii.net/pokedex-sm/479.shtml", image: "http://www.serebii.net/sunmoon/pokemon/479-s.png"},
 {id: "rotom ice", name: "Rotom Frost", dex: 479, alola: -1, type: "Electric/Frost", ability: "Levitate", wiki: "http://www.serebii.net/pokedex-sm/479.shtml", image: "http://www.serebii.net/sunmoon/pokemon/479-f.png"},
 ...
 {id: "giratina-o", name: "Giratina", dex: 487, alola: -1, type: "Ghost/Dragon", ability: "Levitate", wiki: "http://www.serebii.net/pokedex-sm/487.shtml", image: "http://www.serebii.net/sunmoon/pokemon/487-o.png"},
 ...
 {id: "shaymin-s", name: "Shaymin Sky", dex: 492, alola: -1, type: "Grass/Flying", ability: "Serene Grace", wiki: "http://www.serebii.net/pokedex-sm/492.shtml", image: "http://www.serebii.net/sunmoon/pokemon/492-s.png"},
 ...
 {id: "darmanitan-z", name: "Darmanitan Zen", dex: 555, alola: -1, type: "Fire/Psychic", ability: "Zen Mode", wiki: "http://www.serebii.net/pokedex-sm/555.shtml", image: "http://www.serebii.net/sunmoon/pokemon/555-d.png"},
 ...
 {id: "tornadus-t", name: "Tornadus Therian", dex: 641, alola: -1, type: "Flying", ability: "Regenerator", wiki: "http://www.serebii.net/pokedex-sm/641.shtml", image: "http://www.serebii.net/sunmoon/pokemon/641-s.png"},
 ...
 {id: "thundurus-t", name: "Thundurus Therian", dex: 642, alola: -1, type: "Electric/Flying", ability: "Volt Absorb", wiki: "http://www.serebii.net/pokedex-sm/642.shtml", image: "http://www.serebii.net/sunmoon/pokemon/642-s.png"},
 ...
 {id: "landorus-t", name: "Landorus Therian", dex: 645, alola: -1, type: "Ground/Flying", ability: "Intimidate", wiki: "http://www.serebii.net/pokedex-sm/645.shtml", image: "http://www.serebii.net/sunmoon/pokemon/645-s.png"},
 ...
 {id: "meloetta-p", name: "Meloetta Pirouette", dex: 648, alola: -1, type: "Normal/Fighting", ability: "Serene Grace", wiki: "http://www.serebii.net/pokedex-sm/648.shtml", image: "http://www.serebii.net/sunmoon/pokemon/648-s.png"},
 ...
 {id: "hoopa-u", name: "Hoopa Unbound", dex: 720, alola: -1, type: "Psychic/Dark", ability: "Magician", wiki: "http://www.serebii.net/pokedex-sm/720.shtml", image: "http://www.serebii.net/sunmoon/pokemon/720-u.png"},
 ...
 {id: "venusaur-m", name: "Mega Venusaur", dex: 3, alola: -1, type: "Grass/Poison", ability: "Thick Fat", wiki: "http://www.serebii.net/pokedex-sm/003.shtml", image: "http://www.serebii.net/sunmoon/pokemon/003-m.png"},
 {id: "charizard-mx", name: "Mega Charizard X", dex: 6, alola: -1, type: "Fire/Dragon", ability: "Tough Claws", wiki: "http://www.serebii.net/pokedex-sm/006.shtml", image: "http://www.serebii.net/sunmoon/pokemon/006-mx.png"},
 {id: "charizard-my", name: "Mega Charizard Y", dex: 6, alola: -1, type: "Fire/Flying", ability: "Drought", wiki: "http://www.serebii.net/pokedex-sm/006.shtml", image: "http://www.serebii.net/sunmoon/pokemon/006-my.png"},
 {id: "blastoise-m", name: "Mega Blastoise", dex: 9, alola: -1, type: "Water", ability: "Mega Launcher", wiki: "http://www.serebii.net/pokedex-sm/009.shtml", image: "http://www.serebii.net/sunmoon/pokemon/009-m.png"},
 {id: "alakazam-m", name: "Mega Alakazam", dex: 65, alola: -1, type: "Psychic", ability: "Trace", wiki: "http://www.serebii.net/pokedex-sm/065.shtml", image: "http://www.serebii.net/sunmoon/pokemon/065-m.png"},
 {id: "gengar-m", name: "Mega Gengar", dex: 94, alola: -1, type: "Ghost/Poison", ability: "Shadow Tag", wiki: "http://www.serebii.net/pokedex-sm/094.shtml", image: "http://www.serebii.net/sunmoon/pokemon/094-m.png"},
 {id: "kangaskhan-m", name: "Mega Kangaskhan", dex: 115, alola: -1, type: "Normal", ability: "Parental Bond", wiki: "http://www.serebii.net/pokedex-sm/115.shtml", image: "http://www.serebii.net/sunmoon/pokemon/115-m.png"},
 {id: "pinsir-m", name: "Mega Pinsir", dex: 127, alola: -1, type: "Bug/Flying", ability: "Aerilate", wiki: "http://www.serebii.net/pokedex-sm/127.shtml", image: "http://www.serebii.net/sunmoon/pokemon/127-m.png"},
 {id: "gyarados-m", name: "Mega Gyarados", dex: 130, alola: -1, type: "Water/Dark", ability: "Mold Breaker", wiki: "http://www.serebii.net/pokedex-sm/130.shtml", image: "http://www.serebii.net/sunmoon/pokemon/130-m.png"},
 {id: "aerodactyl-m", name: "Mega Aerodactyl", dex: 142, alola: -1, type: "Rock/Flying", ability: "Tough Claws", wiki: "http://www.serebii.net/pokedex-sm/142.shtml", image: "http://www.serebii.net/sunmoon/pokemon/142-m.png"},
 {id: "mewtwo-mx", name: "Mega Mewtwo X", dex: 150, alola: -1, type: "Psychic/Fighting", ability: "Steadfast", wiki: "http://www.serebii.net/pokedex-sm/150.shtml", image: "http://www.serebii.net/sunmoon/pokemon/150-mx.png"},
 {id: "mewtwo-my", name: "Mega Mewtwo Y", dex: 150, alola: -1, type: "Psychic", ability: "Insomnia", wiki: "http://www.serebii.net/pokedex-sm/150.shtml", image: "http://www.serebii.net/sunmoon/pokemon/150-my.png"},
 {id: "ampharos-m", name: "Mega Ampharos", dex: 181, alola: -1, type: "Electric/Dragon", ability: "Mold Breaker", wiki: "http://www.serebii.net/pokedex-sm/181.shtml", image: "http://www.serebii.net/sunmoon/pokemon/181-m.png"},
 {id: "scizor-m", name: "Mega Scizor", dex: 212, alola: -1, type: "Bug/Steel", ability: "Technician", wiki: "http://www.serebii.net/pokedex-sm/212.shtml", image: "http://www.serebii.net/sunmoon/pokemon/212-m.png"},
 {id: "heracross-m", name: "Mega Heracross", dex: 214, alola: -1, type: "Bug/Fighting", ability: "Skill Link", wiki: "http://www.serebii.net/pokedex-sm/214.shtml", image: "http://www.serebii.net/sunmoon/pokemon/214-m.png"},
 {id: "houndoom-m", name: "Mega Houndoom", dex: 229, alola: -1, type: "Dark/Fire", ability: "Solar Power", wiki: "http://www.serebii.net/pokedex-sm/229.shtml", image: "http://www.serebii.net/sunmoon/pokemon/229-m.png"},
 {id: "tyranitar-m", name: "Mega Tyranitar", dex: 248, alola: -1, type: "Rock/Dark", ability: "Sand Stream", wiki: "http://www.serebii.net/pokedex-sm/248.shtml", image: "http://www.serebii.net/sunmoon/pokemon/248-m.png"},
 {id: "blaziken-m", name: "Mega Blaziken", dex: 257, alola: -1, type: "Fire/Fighting", ability: "Speed Boost", wiki: "http://www.serebii.net/pokedex-sm/257.shtml", image: "http://www.serebii.net/sunmoon/pokemon/257-m.png"},
 {id: "gardevoir-m", name: "Mega Gardevoir", dex: 282, alola: -1, type: "Psychic/Fairy", ability: "Pixilate", wiki: "http://www.serebii.net/pokedex-sm/282.shtml", image: "http://www.serebii.net/sunmoon/pokemon/282-m.png"},
 {id: "mawile-m", name: "Mega Mawile", dex: 303, alola: -1, type: "Steel/Fairy", ability: "Huge Power", wiki: "http://www.serebii.net/pokedex-sm/303.shtml", image: "http://www.serebii.net/sunmoon/pokemon/303-m.png"},
 {id: "aggron-m", name: "Mega Aggron", dex: 306, alola: -1, type: "Steel", ability: "Filter", wiki: "http://www.serebii.net/pokedex-sm/306.shtml", image: "http://www.serebii.net/sunmoon/pokemon/306-m.png"},
 {id: "medicham-m", name: "Mega Medicham", dex: 308, alola: -1, type: "Fighting/Psychic", ability: "Pure Power", wiki: "http://www.serebii.net/pokedex-sm/308.shtml", image: "http://www.serebii.net/sunmoon/pokemon/308-m.png"},
 {id: "manectric-m", name: "Mega Manectric", dex: 310, alola: -1, type: "Electric", ability: "Intimidate", wiki: "http://www.serebii.net/pokedex-sm/310.shtml", image: "http://www.serebii.net/sunmoon/pokemon/310-m.png"},
 {id: "banette-m", name: "Mega Banette", dex: 354, alola: -1, type: "Ghost", ability: "Prankster", wiki: "http://www.serebii.net/pokedex-sm/354.shtml", image: "http://www.serebii.net/sunmoon/pokemon/354-m.png"},
 {id: "absol-m", name: "Mega Absol", dex: 359, alola: -1, type: "Dark", ability: "Magic Bounce", wiki: "http://www.serebii.net/pokedex-sm/359.shtml", image: "http://www.serebii.net/sunmoon/pokemon/359-m.png"},
 {id: "garchomp-m", name: "Mega Garchomp", dex: 445, alola: -1, type: "Dragon/Ground", ability: "Sand Force", wiki: "http://www.serebii.net/pokedex-sm/445.shtml", image: "http://www.serebii.net/sunmoon/pokemon/445-m.png"},
 {id: "lucario-m", name: "Mega Lucario", dex: 448, alola: -1, type: "Fighting/Steel", ability: "Adaptability", wiki: "http://www.serebii.net/pokedex-sm/448.shtml", image: "http://www.serebii.net/sunmoon/pokemon/448-m.png"},
 {id: "abomasnow-m", name: "Mega Abomasnow", dex: 460, alola: -1, type: "Grass/Ice", ability: "Snow Warning", wiki: "http://www.serebii.net/pokedex-sm/460.shtml", image: "http://www.serebii.net/sunmoon/pokemon/460-m.png"},
 {id: "beedrill-m", name: "Mega Beedrill", dex: 15, alola: -1, type: "Bug/Poison", ability: "Adaptability", wiki: "http://www.serebii.net/pokedex-sm/015.shtml", image: "http://www.serebii.net/sunmoon/pokemon/015-m.png"},
 {id: "pidgeot-m", name: "Mega Pidgeot", dex: 18, alola: -1, type: "Normal/Flying", ability: "No Guard", wiki: "http://www.serebii.net/pokedex-sm/018.shtml", image: "http://www.serebii.net/sunmoon/pokemon/018-m.png"},
 {id: "slowbro-m", name: "Mega Slowbro", dex: 80, alola: -1, type: "Water/Psychic", ability: "Shell Armor", wiki: "http://www.serebii.net/pokedex-sm/080.shtml", image: "http://www.serebii.net/sunmoon/pokemon/080-m.png"},
 {id: "steelix-m", name: "Mega Steelix", dex: 208, alola: -1, type: "Steel/Ground", ability: "Sand Force", wiki: "http://www.serebii.net/pokedex-sm/208.shtml", image: "http://www.serebii.net/sunmoon/pokemon/208-m.png"},
 {id: "sceptile-m", name: "Mega Sceptile", dex: 254, alola: -1, type: "Grass/Dragon", ability: "Lightning Rod", wiki: "http://www.serebii.net/pokedex-sm/254.shtml", image: "http://www.serebii.net/sunmoon/pokemon/254-m.png"},
 {id: "swampert-m", name: "Mega Swampert", dex: 260, alola: -1, type: "Water/Ground", ability: "Swift Swim", wiki: "http://www.serebii.net/pokedex-sm/260.shtml", image: "http://www.serebii.net/sunmoon/pokemon/260-m.png"},
 {id: "sableye-m", name: "Mega Sableye", dex: 302, alola: -1, type: "Dark/Ghost", ability: "Magic Bounce", wiki: "http://www.serebii.net/pokedex-sm/302.shtml", image: "http://www.serebii.net/sunmoon/pokemon/302-m.png"},
 {id: "sharpedo-m", name: "Mega Sharpedo", dex: 319, alola: -1, type: "Water/Dark", ability: "Strong Jaw", wiki: "http://www.serebii.net/pokedex-sm/319.shtml", image: "http://www.serebii.net/sunmoon/pokemon/319-m.png"},
 {id: "camerupt-m", name: "Mega Camerupt", dex: 323, alola: -1, type: "Fire/Ground", ability: "Sheer Force", wiki: "http://www.serebii.net/pokedex-sm/323.shtml", image: "http://www.serebii.net/sunmoon/pokemon/323-m.png"},
 {id: "altaria-m", name: "Mega Altaria", dex: 334, alola: -1, type: "Dragon/Fairy", ability: "Pixilate", wiki: "http://www.serebii.net/pokedex-sm/334.shtml", image: "http://www.serebii.net/sunmoon/pokemon/334-m.png"},
 {id: "glalie-m", name: "Mega Glalie", dex: 362, alola: -1, type: "Ice", ability: "Refrigerate", wiki: "http://www.serebii.net/pokedex-sm/362.shtml", image: "http://www.serebii.net/sunmoon/pokemon/362-m.png"},
 {id: "salamence-m", name: "Mega Salamence", dex: 373, alola: -1, type: "Dragon/Flying", ability: "Aerilate", wiki: "http://www.serebii.net/pokedex-sm/373.shtml", image: "http://www.serebii.net/sunmoon/pokemon/373-m.png"},
 {id: "metagross-m", name: "Mega Metagross", dex: 376, alola: -1, type: "Steel/Psychic", ability: "Tough Claws", wiki: "http://www.serebii.net/pokedex-sm/376.shtml", image: "http://www.serebii.net/sunmoon/pokemon/376-m.png"},
 {id: "latias-m", name: "Mega Latias", dex: 380, alola: -1, type: "Dragon/Psychic", ability: "Levitate", wiki: "http://www.serebii.net/pokedex-sm/380.shtml", image: "http://www.serebii.net/sunmoon/pokemon/380-m.png"},
 {id: "latios-m", name: "Mega Latios", dex: 381, alola: -1, type: "Dragon/Psychic", ability: "Levitate", wiki: "http://www.serebii.net/pokedex-sm/381.shtml", image: "http://www.serebii.net/sunmoon/pokemon/381-m.png"},
 {id: "rayquaza-m", name: "Mega Rayquaza", dex: 384, alola: -1, type: "Dragon/Flying", ability: "Delta Stream", wiki: "http://www.serebii.net/pokedex-sm/384.shtml", image: "http://www.serebii.net/sunmoon/pokemon/384-m.png"},
 {id: "lopunny-m", name: "Mega Lopunny", dex: 428, alola: -1, type: "Normal/Fighting", ability: "Scrappy", wiki: "http://www.serebii.net/pokedex-sm/428.shtml", image: "http://www.serebii.net/sunmoon/pokemon/428-m.png"},
 {id: "gallade-m", name: "Mega Gallade", dex: 475, alola: -1, type: "Psychic/Fighting", ability: "Inner Focus", wiki: "http://www.serebii.net/pokedex-sm/475.shtml", image: "http://www.serebii.net/sunmoon/pokemon/475-m.png"},
 {id: "audino-m", name: "Mega Audino", dex: 531, alola: -1, type: "Normal/Fairy", ability: "Healer", wiki: "http://www.serebii.net/pokedex-sm/531.shtml", image: "http://www.serebii.net/sunmoon/pokemon/531-m.png"},
 {id: "diancie-m", name: "Mega Diancie", dex: 719, alola: -1, type: "Rock/Fairy", ability: "Magic Bounce", wiki: "http://www.serebii.net/pokedex-sm/719.shtml", image: "http://www.serebii.net/sunmoon/pokemon/719-m.png"},
 ...
 {id: "oricorio electric", name: "Oricorio Pom-Pom Style", dex: 741, alola: 82, type: "Electric/Flying", ability: "Dancer", wiki: "http://www.serebii.net/pokedex-sm/741.shtml", image: "http://www.serebii.net/sunmoon/pokemon/741-p.png"},
 {id: "oricorio psychic", name: "Oricorio Pa'u Style", dex: 741, alola: 82, type: "Psychic/Flying", ability: "Dancer", wiki: "http://www.serebii.net/pokedex-sm/741.shtml", image: "http://www.serebii.net/sunmoon/pokemon/741-pau.png"},
 {id: "oricorio ghost", name: "Oricorio Sensu Style", dex: 741, alola: 82, type: "Ghost/Flying", ability: "Dancer", wiki: "http://www.serebii.net/pokedex-sm/741.shtml", image: "http://www.serebii.net/sunmoon/pokemon/741-s.png"},
 ...
 {id: "lycanroc night", name: "Lycanroc Midnight", dex: 745, alola: 104, type: "Rock", ability: "Keen Eye/Vital Spirit/No Guard", wiki: "http://www.serebii.net/pokedex-sm/745.shtml", image: "http://www.serebii.net/sunmoon/pokemon/745-m.png"},
 {id: "lycanroc dark", name: "Lycanroc Midnight", dex: 745, alola: 104, type: "Rock", ability: "Keen Eye/Vital Spirit/No Guard", wiki: "http://www.serebii.net/pokedex-sm/745.shtml", image: "http://www.serebii.net/sunmoon/pokemon/745-m.png"},
